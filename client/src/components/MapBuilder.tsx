    ...
    <main className="min-h-full bg-[#101510] text-slate-100">
      <header className="flex min-h-16 flex-wrap items-center justify-between gap-3 border-b border-white/10 bg-[#111812]/95 px-4 py-3">
        ...
        <div className="flex flex-wrap items-center gap-2 text-xs font-bold text-slate-300">
          ...
          <button
            type="button"
            onClick={open3DPlaytest}
            className="rounded-md border border-cyan-200/45 px-3 py-2 text-cyan-100 transition hover:bg-cyan-200/10"
          >
            3D playtest
          </button>
          <button
          ...
          <a href="/" className="rounded-md border border-emerald-300/40 px-3 py-2 text-emerald-100 transition hover:bg-emerald-300/10">
            Game
          </a>
        </div>
      </header>
      ...
      <div className="grid min-h-[calc(100dvh-4rem)] grid-cols-1 lg:grid-cols-[18rem_minmax(0,1fr)_22rem]">
        ...
        <aside className="border-t border-white/10 bg-[#121812] p-3 lg:border-l lg:border-t-0">
          <Inspector
            state={state}
            map={activeMap}
